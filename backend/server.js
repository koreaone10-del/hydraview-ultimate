...
const cors = require('cors'); // 👈 تمت إضافة هذه المكتبة هنا
...
// 👈 تفعيل CORS للسماح لموقعك بالاتصال بالخادم
app.use(cors({
    origin: '*', // يسمح لجميع المواقع بالاتصال (أو يمكنك وضع رابط موقعك على GitHub فقط)
    methods: ['GET', 'POST']
}));
